...
vim.cmd "au ColorScheme * hi link @text.title.4.marker Title"
vim.cmd "au ColorScheme * hi link markdownH4Delimiter Title"
vim.cmd "au ColorScheme * hi link RenderMarkdownH1Bg DiffAdd"
vim.cmd "au ColorScheme * hi link RenderMarkdownH2Bg DiffChange"
vim.cmd "au ColorScheme * hi link RenderMarkdownH3Bg DiffDelete"
vim.cmd "au ColorScheme * hi link RenderMarkdownH4Bg DiffDelete"
vim.cmd "au ColorScheme * hi link RenderMarkdownH5Bg DiffDelete"
vim.cmd "au ColorScheme * hi link RenderMarkdownH6Bg DiffDelete"
