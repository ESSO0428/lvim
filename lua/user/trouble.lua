...
function M.setup()
  ...
  local config = {
    ...
    focus = false,          -- Focus the window when opened (defualt false)
    ...
    win = {
      bo = {
        bufhidden = "wipe",
        -- NOTE: use 'Trouble' instead of default 'trouble'
        -- for better plugin compatibility (most plugins detect filetype 'Trouble' not 'trouble')
        filetype = "Trouble",
        buftype = "nofile",
      },
    ...
    keys = {
      ...
      za = "fold_toggle",
      ["<leader>o"] = "fold_toggle",
      zA = "fold_toggle_recursive",
      zm = "fold_more",
      ["[f"] = "fold_more",
      zM = "fold_close_all",
      ["<leader>Oa"] = "fold_close_all",
      ["[g"] = "fold_close_all",
      zr = "fold_reduce",
      ["]f"] = "fold_reduce",
      zR = "fold_open_all",
      ["<leader>Od"] = "fold_open_all",
      ["]g"] = "fold_open_all",
      zx = "fold_update",
      zX = "fold_update_all",
      zn = "fold_disable",
